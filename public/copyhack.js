...
`;
    ...
    // console.log("cbh_head", {cbh_head})
    let cbh_style = document.createElement('style');
    // console.log("cbh_style", {cbh_style})
    ...
    document.addEventListener('contextmenu', function (evt) {
        console.log('in contextmenu listener')
    ...
    document.getElementById('webview_copy').onclick = function () {
        console.log('in webview copy', webview_copy_value)
    ...
    document.getElementById('webview_paste').onclick = function () {
        console.log('in webview paste', webview_copy_value)
